...
class DocumentChunker:
    ...
    TextSplitChunker, and for PDF, returns SemanticChunker"""
    def __new__(
        cls,
        leaf_node = None,
        ...
        Args:
            ...
            tokenizer_model_name (str): name of huggingface model to get
                tokenizer from 
        Returns:
            TextSplitChunker | Semantic Chunker: Object of the appropriate
                chunker class for the provided filetype
        """
        print(f"THIS IS KHALED: {output_dir=}")
...
class TextSplitChunker(ChunkerBase):
    def __init__(
        ...
        print(f"THIS IS KHALED IN TEXT SPLIT CHUNKER")
    ...
    def chunk_documents(self) -> Dataset:
        ...
        """
        num_tokens_per_doc = self._num_tokens_from_words()
